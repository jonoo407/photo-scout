...
const SPOTS: Spot[] = [
  ...
  },
  {
    ...
    craft: {
      ...
      accessTips: 'Exterior always free, any hour. Interior 9 AM–5 PM by free timed ticket; winter months may not require one.',
    },
  ...
  },
  {
    ...
    caveats: 'Steeple and facade are street views, any hour; the interior is 11 AM–5 PM for a small donation. An active church — be respectful of services, especially Sunday worship.',
    craft: {
  ...
  },
  {
    ...
    caveats: 'Free, open dawn to dusk. The skyline is distant to the north — a long lens compresses it over the water. Best reflection is the north lakeshore, not the entrance. Ongoing redevelopment may close some paths.',
    craft: {
  ...
  },
  {
    ...
    caveats: 'A public street at any hour, but the stalls trade roughly 8 AM–5 PM — most vendors dark on Mondays, Sundays mornings-only. A working market — keep tripods off the narrow sidewalk and ask vendors before close portraits.',
    craft: {
