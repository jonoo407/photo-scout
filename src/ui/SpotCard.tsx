    ...
    <button className="spotcard" onClick={onPress ?? (() => nav(`/spot/${spot.id}`))}>
      <div className="body">
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {/* Sell the shot, not the street: what's photographically here.
              The address lives on the detail page, where it's actionable. */}
          {spot.bestFor.length > 0 && <p className="cardwhy">{spot.bestFor.slice(0, 3).join(' · ')}</p>}
