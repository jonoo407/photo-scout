...
3. ~~**Deploy**~~ — DONE. Live at **https://jonoo407.github.io/photo-scout/** via GitHub Pages + Actions (`.github/workflows/deploy.yml`, auto-deploys on push to `main`). Repo: https://github.com/jonoo407/photo-scout (public). Note: spot photos hotlink `upload.wikimedia.org` (online-only; SW doesn't cache them). Workflow actions warn about Node-20 deprecation (forced to Node 24 ~2026-06-16) — bump action versions if a future run breaks.
